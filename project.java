...
cm to pixels
 ...
 line(pixsDistance*cos(radians(iAngle)), -pixsDistance*sin(radians(iAngle)), (widthwidth*0.505)*cos(radians(iAngle)), -(width-width*0.505)*sin(radians(iAngle)));
 }
 popMatrix();
}
void drawLine() {
...
void drawText() { // draws the texts on the screen
 ...
 textSize(40);
 text("FR Tech", width-width*0.875, height-height*0.0277);
